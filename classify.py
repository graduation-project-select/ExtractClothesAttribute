...
def classify(image, model, lb, output = []):
...
setGPU()
image, originalImage = imagePreprocessing(args["image"])
model, lb = loadModel(args["model"], args["labelbin"])

classify(image, model, lb, output=originalImage)
